...
void Inception :: set_params(struct InceptionParams params) {
    ...
    layer2.set_params(params.param_l2);
    layer3.set_params(params.param_l3);
    layer4.set_params(params.param_l4);
    layer5.set_params(params.param_l5);
    layer6.set_params(params.param_l6);
...
double* Inception :: cpu_forward(double *input, const int batch_size) {
    ...
    double *layer5_o = layer3.cpu_forward(layer4_4_o, batch_size);
    free(layer4_4_o);

    double *layer6_1_o = layer3.cpu_forward(layer5_o, batch_size);
    free(layer5_o);
    double *layer6_2_o = layer3.cpu_forward(layer6_1_o, batch_size);
    free(layer6_1_o);
...
double* Inception :: gpu_forward(double *input, const int batch_size) {
    ...
    double *layer5_o = layer3.gpu_forward(layer4_4_o, batch_size);
    cudaFree(layer4_4_o);

    double *layer6_1_o = layer3.gpu_forward(layer5_o, batch_size);
    cudaFree(layer5_o);
    double *layer6_2_o = layer3.gpu_forward(layer6_1_o, batch_size);
    cudaFree(layer6_1_o);
