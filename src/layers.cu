...
void InceptionLayer6 :: set_params(struct InceptionLayer6params params) {
    ...
    way2_2.set_params(params.way2_2_w, params.way_2_2_b);
    way3_2.set_params(params.way3_2_w, params.way_3_2_b);
...
void InceptionLayer6 :: cpu_forward(float *input, const int batch_size) {
    // way1
    ...
    float *concat_in1[] = {way2_o2, way3_o2}, concat_ch1[] = {384, 384};
    ...
    float *concat_in2[] = {way4_o3, way5_o3}, concat_ch2[] = {384, 384};
    ...
    free(way6_o1);
    // final
    float *concat_in_final[] = {way1_o, way23_o, way45_o, way6_o}, concat_ch_final = {320, 768, 768, 192};
...
void InceptionLayer6 :: gpu_forward(float *input, const int batch_size) {
